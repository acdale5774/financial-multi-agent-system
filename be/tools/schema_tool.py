...
_TABLE_NOTES: dict[str, str] = {
    ...
    "financials": (
        ...
        "  * income: FY and Q1-Q4 are loaded.\n"
        "  * balance: annual snapshots are labeled 'Q4' (SimFin convention — a balance\n"
        "    sheet is point-in-time at fiscal year end). There are no 'FY' balance rows.\n"
